================================================================================
    MICROSOFT 基础类库 : 坦克大战系列 项目概述
===============================================================================
    微软真TM会省事  == 作者标
==============================================================================

应用程序向导已为您创建了此 坦克大战系列 应用程序。此应用程序不仅演示 Microsoft 基础类的基本使用方法，还可作为您编写应用程序的起点。

本文件概要介绍组成 坦克大战系列 应用程序的每个文件的内容。

坦克大战系列.vcxproj
    这是使用应用程序向导生成的 VC++ 项目的主项目文件，其中包含生成该文件的 Visual C++ 的版本信息，以及有关使用应用程序向导选择的平台、配置和项目功能的信息。

坦克大战系列.vcxproj.filters
    这是使用“应用程序向导”生成的 VC++ 项目筛选器文件。它包含有关项目文件与筛选器之间的关联信息。在 IDE 中，通过这种关联，在特定节点下以分组形式显示具有相似扩展名的文件。例如，“.cpp”文件与“源文件”筛选器关联。

坦克大战系列.h
    这是应用程序的主头文件。
    其中包括其他项目特定的标头（包括 Resource.h），并声明 C坦克大战系列App 应用程序类。

坦克大战系列.cpp
    这是包含应用程序类 C坦克大战系列App 的主应用程序源文件。

坦克大战系列.rc
    这是程序使用的所有 Microsoft Windows 资源的列表。它包括 RES 子目录中存储的图标、位图和光标。此文件可以直接在 Microsoft Visual C++ 中进行编辑。项目资源包含在 2052 中。

res\坦克大战系列.ico
    这是用作应用程序图标的图标文件。此图标包括在主资源文件 坦克大战系列.rc 中。
...
坦克大战系列Dlg.h、坦克大战系列Dlg.cpp - 对话框
    这些文件包含 C坦克大战系列Dlg 类。此类定义应用程序的主对话框的行为。对话框模板包含在 坦克大战系列.rc 中，该文件可以在 Microsoft Visual C++ 中编辑。
...
StdAfx.h, StdAfx.cpp
    这些文件用于生成名为 坦克大战系列.pch 的预编译头 (PCH) 文件和名为 StdAfx.obj 的预编译类型文件。
